...
Route::get("/kategóriák/{category}",[FrontendCategoryController::class,'show'])->name('categories.show');
...
Route::post("/kommentek",[FrontendCommentController::class,'storeComment'])->name('comment.store');
