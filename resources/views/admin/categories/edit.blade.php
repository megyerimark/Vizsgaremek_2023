<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700  text-white rounded-lg">Kategória Index</a>
            </div>
  ...
  <form method="POST" action=" {{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
    ...
    <div class="sm:col-span-6">
      ...
      <div class="mt-1">
        <input type="text" id="name" id="name" name="name" value="{{$category->name}}" 
