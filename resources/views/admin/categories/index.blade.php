          ...
          <tr class="bg-white border-b darg:bg-gray-800 dark:border-gray-700">
            ...
            <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <div class="flex space-x-2">
                    <a href="{{route('admin.categories.edit', $category->id)}}" class="px-4 py-2 bg-blue-500 hover:bg-green-700 rounded"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
