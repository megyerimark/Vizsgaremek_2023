<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700  text-white rounded-lg">Foglalás Index</a>
            </div>
  ...
  <form enctype="multipart/form-data">
    ...
    <div class="sm:col-span-6">
      <label for="title" class="block text-sm font-medium text-gray-700"> Kép </label>
      <div class="mt-1">
