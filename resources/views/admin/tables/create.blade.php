<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700  text-white rounded-lg">Asztal Index</a>
            </div>
  ...
  <form method="POST" action="{{ route('admin.tables.store')}}">
    ...
    <div class="sm:col-span-6">
      <label for="title" class="block text-sm font-medium text-gray-700"> Név </label>
      <div class="mt-1">
    ...
    <div class="sm:col-span-6">
      <label for="guest_number" class="block text-sm font-medium text-gray-700"> Vendégek száma </label>
      <div class="mt-1">
        <input type="text" id="guest_number" wire:model.lazy="guest_number" name="guest_number" 
    ...
    <div class="mt-6 p-4">
    <button type="submit" 
    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg">Mentés</button>
</div>
