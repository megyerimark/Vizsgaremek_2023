                        ...
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('reservation.store.step.one') }}">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="first_name" class="block text-sm font-medium text-gray-700"> Vezetéknév
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="last_name" class="block text-sm font-medium text-gray-700"> Keresztnév
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Következő</button>
                                </div>
                            </form>
                        </div>
                    </div>
